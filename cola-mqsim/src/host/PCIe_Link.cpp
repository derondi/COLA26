...
namespace Host_Components
{
	...
	void PCIe_Link::Execute_simulator_event(MQSimEngine::Sim_Event* event)
	{
        ...
        LOG("HOST, object=%s", event->Target_sim_object->ID().c_str());
        ...
        LOG("DEVICE, object=%s", event->Target_sim_object->ID().c_str());
