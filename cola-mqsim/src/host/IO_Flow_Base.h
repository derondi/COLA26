...
#define NVME_UPDATE_SQ_TAIL(Q)  Q.Submission_queue_tail++;\
	...
	public:
		...
		double Get_P999_device_response_time_read();//in microseconds
		double Get_device_response_time();//in microseconds
		double Get_min_device_response_time();//in microseconds
		double Get_max_device_response_time();//in microseconds
		double Get_end_to_end_request_delay();//in microseconds
		double Get_min_end_to_end_request_delay();//in microseconds
		double Get_max_end_to_end_request_delay();//in microseconds
	...
	protected:
		...
		std::vector<sim_time_type> STAT_P999_device_response_time_read;
		...
		double Get_device_response_time_short_term();//in microseconds
		double Get_end_to_end_request_delay_short_term();//in microseconds
