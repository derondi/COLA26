...
namespace SSD_Components
{
	...
	*/
	...
	{
	public:
		Data_Cache_Manager_Flash_Advanced(const sim_object_id_type& id, Host_Interface_Base* host_interface, NVM_Firmware* firmware, ECCEngine* ecc,
    ...
    NVM_PHY_ONFI* flash_controller;
		...
		static void handle_transaction_serviced_signal_from_ECC(NVM_Transaction_Flash* transaction);
