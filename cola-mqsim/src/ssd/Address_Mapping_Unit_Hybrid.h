...
namespace SSD_Components
{
	...
	{
	public:
		Address_Mapping_Unit_Hybrid(sim_object_id_type id, FTL* ftl, ECCEngine* ecc, NVM_PHY_ONFI* flash_controller,
      Flash_Block_Manager_Base* block_manager, bool ideal_mapping_table, unsigned int ConcurrentStreamNo,
