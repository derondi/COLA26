...
#define MAKE_TABLE_INDEX(LPN,STREAM)
	...
	* its own share of CMT (equal partitioning of CMT space among concurrent streams).*/
	...
	public:
		Address_Mapping_Unit_Page_Level(const sim_object_id_type& id, FTL* ftl, NVM_PHY_ONFI* flash_controller, ECCEngine *ecc, Flash_Block_Manager_Base* block_manager,
