...
{
	Address_Mapping_Unit_Base::Address_Mapping_Unit_Base(const sim_object_id_type& id, FTL* ftl, ECCEngine* ecc, NVM_PHY_ONFI* flash_controller,
    Flash_Block_Manager_Base* block_manager, bool ideal_mapping_table, unsigned int no_of_input_streams,
		...
		: Sim_Object(id), ftl(ftl), ecc(ecc), flash_controller(flash_controller), block_manager(block_manager),
