...
namespace SSD_Components
{
	...
	public:
		...
		double TwoUnitDataOutTime; //The DDR delay for two-unit device data out
		...
		double TwoUnitDataInTime; //The DDR delay for two-unit device data in
	...
	private:
		...
		double t_RC; //Average RE cycle time, e.g. 6ns
		double t_DSC; //Average DQS cycle time, e.g. 6ns
