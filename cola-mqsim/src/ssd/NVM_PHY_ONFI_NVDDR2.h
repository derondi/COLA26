...
namespace SSD_Components
{
	enum class NVDDR2_SimEventType
	{
		...
		ERASE_SETUP_COMPLETED, ECC_DATA_TRANSFERRED,
	};
    ...
    const ONFI_Channel_NVDDR2 *Get_channel(flash_channel_ID_type channelID);
    ...
    ECCMetadata GetECCMetadata(flash_channel_ID_type channe_id, flash_chip_ID_type chip_id, flash_die_ID_type die_id, flash_plane_ID_type plane_id, flash_block_ID_type block_id, flash_page_ID_type page_id);
